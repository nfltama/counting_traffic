...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='videos/motor10s.mp4', help='source')  # file/folder, 0 for webcam
...
if __name__ == '__main__':
    opt = parse_opt()
    # Menginisialisasi variabel stframe, car, bus, truck, motor, line, fps_rate, class_id
    stframe = ...
    car = ...
    bus = ...
    truck = ...
    ...
    with torch.no_grad():
        detect(opt, stframe, car, bus, truck, motor, line, fps_rate, class_id)